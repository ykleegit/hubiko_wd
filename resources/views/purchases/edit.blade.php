                            ...
                            <div class="row" id="vender-box">
                                <div class="form-group col-md-6" id="account-box">
                                    ...
                                    <select class="form-control account_type {{ !empty($errors->first('account_type')) ? 'is-invalid' : '' }}"
                                        name="account_type" id="account_type" disabled>
                                    ...
                                    <input type="hidden" name="account_type" value="{{ $purchase->account_type ?? '' }}">
                                </div>
                                <div class="col-md-6">
                                    @if (module_is_active('Account'))
                                        ...
                                        <div class="form-group account_vendor">
                                            ...
                                            {{ Form::select('vender_id', $venders, $purchase->user_id ?? null, ['class' => 'form-control select ', 'id' => 'vender', 'data-url' => route('purchases.vender'), 'required' => 'required', 'placeholder' => 'Select vender']) }}
                                        </div>
                                    @else
