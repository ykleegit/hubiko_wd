                    ...
                    <div id="table-scroll" class="table-scroll">
                        <div class="table-wrap">
                            ...
                            <div
                                ...
                                <div class="basic-plan-card compare-card">
                                    <div class="basic-plan text-center mb-4">
                                        <h4>{{ __('Compare our plans') }}</h4>
                                    </div>
                                    <ul class="basic-plan-ul compare-plan-opction p-0 h-100">
                                ...
                                @foreach ($plan as $single_plan)
                                    @if ($single_plan->status == 1)
                                        ...
                                        <div class="basic-plan-card">
                                            <div class="basic-plan text-center mb-4">
                                                <h4 class="text-break">{{ !empty($single_plan->name) ? $single_plan->name : __('Basic') }}
                                                </h4>
                                                <div class="price">
