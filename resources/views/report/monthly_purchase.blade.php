    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link" id="pills-home-tab" data-bs-toggle="pill"
               href="{{ route('reports.daily.purchase') }}"
               onclick="window.location.href = '{{ route('reports.daily.purchase') }}'" role="tab"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " >
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['reports.monthly.purchase'], 'method' => 'GET', 'id' => 'monthly_purchase_report_submit']) }}
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                <a href="#" class="btn btn-sm btn-primary me-1"
                                   ...
                                   data-toggle="tooltip" data-original-title="{{ __('apply') }}" title="{{ __('Apply') }}">
                                    <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                </a>
                                <a href="{{ route('reports.monthly.purchase') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
