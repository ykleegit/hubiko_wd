    ...
    <div class="row mt-2">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('amount', '', array('class' => 'form-control bank_amount','required'=>'required',"min"=>"0",'placeholder' => __('Enter Amount'))) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('reference', '', array('class' => 'form-control','placeholder' => 'Enter Reference')) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
