...
class SportsAndClubBookingSerivceProvider extends ServiceProvider
{
    /**
    ...
    public function boot(){
        ...
        view()->composer(['sports-club-and-academy-management::frontend.sportsfooter'], function ($view)
        {
            ...
            {
                $view->getFactory()->startPush('sports_and_club_payment', view('paypal::payment.sports_and_club_payment',compact('slug')));
            }
        });
    }
