...
use Hubiko\ProductService\Events\CreateCategory;
use Hubiko\ProductService\Events\DestroyCategory;
use Hubiko\ProductService\Events\UpdateCategory;
...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $product_categories = \Hubiko\ProductService\Entities\Category::where('created_by', '=', creatorId())->where('workspace_id',getActiveWorkSpace())->where('type',0)->get();
            $income_categories = \Hubiko\ProductService\Entities\Category::where('created_by', '=', creatorId())->where('workspace_id',getActiveWorkSpace())->where('type',1)->get();
            $expance_categories = \Hubiko\ProductService\Entities\Category::where('created_by', '=', creatorId())->where('workspace_id',getActiveWorkSpace())->where('type',2)->get();
            $taxes = \Hubiko\ProductService\Entities\Tax::where('created_by',creatorId())->where('workspace_id',getActiveWorkSpace())->get();
            $units = \Hubiko\ProductService\Entities\Unit::where('created_by',creatorId())->where('workspace_id',getActiveWorkSpace())->get();
