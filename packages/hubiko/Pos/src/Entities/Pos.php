...
class Pos extends Model
{
    ...
    public function customer()
    {
        ...
        {
            return $this->hasOne(\Hubiko\Account\Entities\Customer::class, 'user_id', 'customer_id');
        }else{
    ...
    {
        return $this->hasOne('\Hubiko\ProductService\Entities\Tax', 'id', 'tax');
    }
    ...
    public static function getallCategories()
    {
        ...
        {
            $cat = \Hubiko\ProductService\Entities\Category::select('categories.*', \DB::raw("COUNT(pu.category_id) product_services"))
    ...
    public static function getallproducts()
    {
        if(module_is_active('ProductService'))
        {
            return \Hubiko\ProductService\Entities\ProductService::select('product_services.*', 'c.name as categoryname')
    ...
    public static function tax_id($product_id)
    {
        if(module_is_active('ProductService'))
        {
            ...
            $results = \Hubiko\ProductService\Entities\ProductService::where(['id'=>$product_id, 'created_by'=> creatorId(), 'workspace_id' => getActiveWorkSpace() ])->first();
    ...
    public static function tax($taxData)
    {
        ...
        if(!empty($taxData)){
            ...
            {
                $taxes[] = \Hubiko\ProductService\Entities\Tax::find($tax);
            }
        }
    ...
    public static function totalTaxRate($taxes)
    {
        if(is_null(self::$taxes)){
            self::$taxes  = \Hubiko\ProductService\Entities\Tax::whereIn('id', explode(',', $taxes))->get();
        }
    ...
    public static function total_quantity($type, $quantity, $product_id)
    {
        if(module_is_active('ProductService'))
        {
            $product      = \Hubiko\ProductService\Entities\ProductService::find($product_id);
