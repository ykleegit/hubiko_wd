...
use Hubiko\Account\DataTables\DebitNoteDataTable;
...
use Hubiko\Account\Entities\DebitNote;
...
class CustomerDebitNotesController extends Controller
{
    ...
    public function getItemPrice(Request $request)
    {
        ...
        if($billProduct != null)
        {
            $product        = \Hubiko\ProductService\Entities\ProductService::find($billProduct->product_id);
