...
use Hubiko\Account\Entities\CustomerCreditNotes;
use App\Models\Invoice;
use App\Models\InvoiceProduct;
use App\Models\User;
use Hubiko\Account\DataTables\CreditNoteDataTable;
use Hubiko\Account\Entities\AccountUtility;
use Hubiko\Account\Entities\Customer;
use App\Traits\CreditDebitNoteBalance;
use Hubiko\Account\Entities\CreditNote;
...
class CustomerCreditNotesController extends Controller
{
    ...
    public function getItemPrice(Request $request)
    {
        ...
        {
            $product        = \Hubiko\ProductService\Entities\ProductService::find($invoiceProduct->product_id);
