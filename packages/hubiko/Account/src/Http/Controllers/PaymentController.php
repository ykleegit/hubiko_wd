...
use Hubiko\Account\DataTables\PaymentDataTable;
...
class PaymentController extends Controller
{
    ...
    public function create()
    {
        if(\Auth::user()->isAbleTo('expense payment create'))
        {
            ...
            if(module_is_active('ProductService'))
            {
                $categories = \Hubiko\ProductService\Entities\Category::where('created_by', '=', creatorId())->where('workspace_id', getActiveWorkSpace())->where('type','2')->get()->pluck('name', 'id');
            }
    ...
    public function store(Request $request)
    {
        if(Auth::user()->isAbleTo('expense payment create'))
        {
            ...
            $category            = \Hubiko\ProductService\Entities\Category::where('id', $request->category_id)->first();
