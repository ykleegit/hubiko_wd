                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @php
                                    ...
                                    $totalDebit  = 0;
                                    $totalCredit = 0;
                                    $chartDatas  = \Hubiko\Account\Entities\AccountUtility::getAccountData($account->id,$filter['startDateRange'],$filter['endDateRange']);
                                    $accountName = \Hubiko\Account\Entities\ChartOfAccount::find($account->id);
                                @endphp
                                @php
                                    $debitTotal = 0;
                                    $creditTotal = 0;
                                ...
                                @foreach ($chartDatas as $transaction)
                                    @php
                                        $account = \Hubiko\Account\Entities\ChartOfAccount::find($transaction->account_id);
