                ...
                <div class="col-sm-6 col-12">
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            ...
                            <h3 class="mb-0">{{ \Hubiko\Account\Entities\AccountUtility::countCustomers() }}
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-12">
                    <div class="dashboard-project-card">
                        <div class="card-inner  d-flex justify-content-between">
                            ...
                            <h3 class="mb-0">{{ \Hubiko\Account\Entities\AccountUtility::countVendors() }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-12">
                ...
                <div class="col-sm-6 col-12">
                    <div class="dashboard-project-card">
                        <div class="card-inner d-flex justify-content-between">
                            ...
                            <h3 class="mb-0">{{ \Hubiko\Account\Entities\AccountUtility::countBills() }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <h4 class="mb-0 text-success">
                                            {{ currency_format_with_sym(\Hubiko\Account\Entities\AccountUtility::todayIncome()) }}
                                        </h4>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <h4 class="mb-0 text-info">
                                            {{ currency_format_with_sym(\Hubiko\Account\Entities\AccountUtility::todayExpense()) }}
                                        </h4>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <h4 class="mb-0 text-warning">
                                            {{ currency_format_with_sym(\Hubiko\Account\Entities\AccountUtility::incomeCurrentMonth()) }}
                                        </h4>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="ms-2">
                                        ...
                                        <h4 class="mb-0 text-danger">
                                            {{ currency_format_with_sym(\Hubiko\Account\Entities\AccountUtility::expenseCurrentMonth()) }}
                                        </h4>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @forelse($recentBill as $bill)
                                        <tr>
                                            <td>{{ \Hubiko\Account\Entities\Bill::billNumberFormat($bill->bill_id) }}
                                            </td>
                                            ...
                                            <td>
                                                @if ($bill->status == 0)
                                                    <span
                                                        class="p-2 px-3 badge bg-info">{{ __(\Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 1)
                                                    <span
                                                        class="p-2 px-3 badge bg-primary">{{ __(\Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 2)
                                                    <span
                                                        class="p-2 px-3 badge bg-secondary">{{ __(\Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 3)
                                                    <span
                                                        class="p-2 px-3 badge bg-warning">{{ __(\Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 4)
                                                    <span
                                                        class="p-2 px-3 badge bg-success">{{ __(\Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
