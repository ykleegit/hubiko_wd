        ...
        <div class="table-responsive">
            <table class="table mb-0 pc-dt-simple" id="credir-note">
                ...
                @forelse($invoice->creditNote as $key =>$creditNote)
                    <tr>
                        <td><a href="#" class="btn btn-outline-primary">{{ !empty($creditNote->creditNote) ? \Hubiko\Account\Entities\CustomerCreditNotes::creditNumberFormat($creditNote->creditNote->credit_id) : '-' }}</a></td>
