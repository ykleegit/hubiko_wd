                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="p-2">
                                                ...
                                                <h6 class="report-text mb-3">
                                                    {{ Hubiko\Account\Entities\Vender::vendorNumberFormat($vendor->vendor_id) }}
                                                </h6>
                                                ...
                                                <tr class="font-style">
                                                    <td class="Id">
                                                        @permission('bill show')
                                                            <a href="{{ route('bill.show', \Crypt::encrypt($bill->id)) }}"
                                                                class="btn btn-outline-primary">{{ Hubiko\Account\Entities\Bill::billNumberFormat($bill->bill_id) }}
                                                            </a>
                                                        @else
                                                            <a
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($bill->status == 2)
                                                            <span
                                                                class="badge bg-secondary p-2 px-3">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span>
                                                                    ...
                                                                    <tbody class="list">
                                                                        ...
                                                                        @forelse($bill_payment as $payment)
                                                                            <tr>
                                                                                ...
                                                                                <td>{{ \Hubiko\Account\Entities\Bill::billNumberFormat($payment->bill_id) }}
                                                                                </td>
