                            ...
                            <div class="d-flex align-items-start gap-2">
                                ...
                                <div class="invoice-content">
                                    ...
                                    <p class="text-sm mb-3">{{ __('Status') }} :
                                        @if ($bill->status == 0)
                                            <span>{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                        ...
                                        <div>
                                            <div class="d-flex invoice-wrp flex-wrap align-items-center gap-md-2 gap-1">
                                                ...
                                                <h3 class="invoice-number mb-0">
                                                    {{ Hubiko\Account\Entities\Bill::billNumberFormat($bill->bill_id) }}
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-sm-4 p-3 invoice-billed">
                                        <div class="row row-gap">
                                            ...
                                            <div class="col-lg-2 col-sm-6">
                                                ...
                                                @if ($bill->status == 0)
                                                    <span
                                                        class="badge fix_badge f-12 p-2 d-inline-block bg-info">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 1)
                                                    <span
                                                        class="badge fix_badge f-12 p-2 d-inline-block bg-primary">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 2)
                                                    <span
                                                        class="badge fix_badge f-12 p-2 d-inline-block bg-secondary">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 3)
                                                    <span
                                                        class="badge fix_badge f-12 p-2 d-inline-block bg-warning">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @elseif($bill->status == 4)
                                                    <span
                                                        class="badge fix_badge f-12 p-2 d-inline-block bg-success">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                @endif
                                            </div>
                                        ...
                                        <div class="mt-2 table-responsive">
                                            <table class="table mb-0 table-striped">
                                                ...
                                                @foreach ($iteams as $key => $iteam)
                                                    @if (!empty($iteam->tax))
                                                        @php
                                                            $taxes = Hubiko\Account\Entities\AccountUtility::tax(
                                                                $iteam->tax,
                                                            );
                                                            ...
                                                            foreach ($taxes as $taxe) {
                                                                $taxDataPrice = Hubiko\Account\Entities\AccountUtility::taxRate(
                                                                    $taxe['rate'],
                                                                    $iteam->price,
                                                                    $iteam->quantity,
                                                                    $iteam->discount,
                                                    ...
                                                    <tr>
                                                            ...
                                                            @if (!empty($iteam->tax))
                                                                <table>
                                                                    ...
                                                                    @foreach ($taxes as $tax)
                                                                        @php
                                                                            $taxPrice = Hubiko\Account\Entities\AccountUtility::taxRate(
                                                                                $tax['rate'],
                                                                                $iteam->price,
                                                                                $iteam->quantity,
                                                                                $iteam->discount,
                                                        ...
                                                        @if ($bill->bill_module == 'account' || $bill->bill_module == '')
                                                            @php
                                                                $chartAccount = \Hubiko\Account\Entities\ChartOfAccount::find(
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 pc-dt-simple" id="debit-note">
                                    ...
                                    @forelse($bill->debitNote as $key =>$debitNote)
                                        <tr>
                                            <td><a href="#" class="btn btn-outline-primary">{{ !empty($debitNote->debitNote) ? \Hubiko\Account\Entities\CustomerDebitNotes::debitNumberFormat($debitNote->debitNote->debit_id) : '-' }}</a></td>
