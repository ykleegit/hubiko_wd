                        ...
                        <div class="card">
                            <div class="card-body p-2">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('bill_template', Hubiko\Account\Entities\AccountUtility::templateData()['templates'], !empty($settings['bill_template']) ? $settings['bill_template'] : null, ['class' => 'form-control', 'required' => 'required']) }}
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body p-2">
                                @foreach (Hubiko\Account\Entities\AccountUtility::templateData()['colors'] as $key => $color)
