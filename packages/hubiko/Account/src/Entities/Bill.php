...
class Bill extends Model
{
    ...
    public function category()
    {
        ...
        {
            return $this->hasOne(\Hubiko\ProductService\Entities\Category::class, 'id', 'category_id');
        }
    }
    ...
    public function customdebitNote()
    {
        if(module_is_active('Account'))
        {
            ...
            return $this->hasMany(\Hubiko\Account\Entities\CustomerDebitNotes::class, 'bill', 'id');
        }
        else
        {
            return [];
    ...
    public function billTotalCustomerDebitNote()
    {
        if(module_is_active('Account'))
        {
            return $this->hasMany(\Hubiko\Account\Entities\CustomerDebitNotes::class, 'bill', 'id')->sum('amount');
        }
        else
        {
            return 0;
