...
class CustomerCreditNotes extends Model
{
    ...
    {
        return $this->hasOne(\Hubiko\Account\Entities\Customer::class, 'id', 'customer');
    }
    ...
    {
        return $this->hasMany(\Hubiko\Account\Entities\CreditNote::class, 'credit_note', 'id')->sum('amount');
    }
