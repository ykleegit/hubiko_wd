...
namespace Hubiko\Account\Entities;
...
class AccountUtility extends Model
{
    ...
    //             $allTaxes = \Hubiko\ProductService\Entities\Tax::whereIn('id', $taxIds)->get();
    ...
    public static function addTransactionLines($data , $action = '' , $type = '')
    {
        if($type == 'notes')
        {
            $existingTransaction = \Hubiko\Account\Entities\AddTransactionLine::where('reference', $data['reference'])
        ...
        {
            $existingTransaction = \Hubiko\Account\Entities\AddTransactionLine::where('account_id', $data['account_id'])
        ...
        if ($existingTransaction && $action == 'edit') {
            ...
            $transactionLines = new  \Hubiko\Account\Entities\AddTransactionLine();
        }
