...
class SEOHubServiceProvider extends ServiceProvider
{
    protected $moduleName = 'SEOHub';
    protected $moduleNameLower = 'seohub';
    ...
    {
        Event::subscribe(\Hubiko\SEOHub\Listeners\SEOEventListener::class);
    }
