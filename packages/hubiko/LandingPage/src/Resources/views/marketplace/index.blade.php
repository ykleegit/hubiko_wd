...
@php
    ...
    $marketplace = \Hubiko\LandingPage\Entities\MarketplacePageSetting::settings($module->name);
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <div class="cart-view btn-group">
                                ...
                                <a href="{!! $marketplace['product_main_demo_link'] !!}" class="link-btn">{!! $marketplace['product_main_demo_button_text'] !!} <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-image-wrapper">
                            <div class="pdp-media banner-img-wrapper">
                                ...
                                <img src="{{ check_file($marketplace['product_main_banner']) ? get_file($marketplace['product_main_banner']) : asset($old_path."/image1.png") }}" alt="" class="inner-frame-img">
                        </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row row-gap padding-bottom ">
                                ...
                                <div class="col-lg-7 col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="{{ check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : (check_file($old_path."/image".$img.".png") ? asset($old_path."/image".$img.".png") : asset($old_path."/image1.png")) }}" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                            </div>
                        @else
                                    ...
                                    <div class="tab-content active" id="tab-1">
                                        <div class="pricing-content">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="{!! $marketplace['pricing_plan_demo_link'] !!}" class="link-btn">{!! $marketplace['pricing_plan_demo_button_text'] !!}<svg
                        ...
                        @endphp
                            <div class="screenshot-itm">
                                <div class="screenshot-image">
                                    <a href="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) :(check_file($old_path."/image".$imageKey.".png") ? asset($old_path."/image".$imageKey.".png") : asset($old_path."/image3.png")) }}" target="_blank" class="img-zoom">
                                        <img src="{{ check_file($value['screenshots']) ? get_file($value['screenshots']) :(check_file($old_path."/image".$imageKey.".png") ? asset($old_path."/image".$imageKey.".png") : asset($old_path."/image3.png")) }}" alt="" class="inner-frame-img">
                                    </a>
                                </div>
                            </div>
                    @endforeach
