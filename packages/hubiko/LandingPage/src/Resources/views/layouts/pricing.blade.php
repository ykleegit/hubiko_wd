@php
    ...
    $settings = \Hubiko\LandingPage\Entities\LandingPageSetting::settings();
        ...
        @if (admin_setting('custome_package') == 'on' && admin_setting('plan_package') == 'on')
                <div class="tab-head-row">
                    <ul class="tabs d-flex justify-content-center">
                        <li>
                            <a href="{{ route('apps.pricing.plan') }}" class="nav-link " >{{ __('Pre-Packaged Subscription') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('apps.pricing') }}" class="nav-link active" >{{ __('Usage Subscription') }}</a>
                        </li>
                    </ul>
            </div>
        @endif
                                                    ...
                                                    <div class="product-img">
                                                        <div class="theme-avtar">
                                                            <a
                                                                ...
                                                                <img src="{{ get_module_img($module->name) }}"
                                    ...
                                    <li>
                                        <span class="cart-sum-left">
                                            <h6 class="mb-0">{{ __('Workspace') }} <small
                                                    class="text-muted workspace-price">{{ '( '. __('Per Workspace') . super_currency_format_with_sym($workspaceprice) . ' )' }}</small>
                                            </h6>
                                        </span>
                                        <span class="cart-sum-right"><b
