                                    ...
                                    <div class="col-md-1 col-sm-6">
                                        @permission('deal edit')
                                            <span class="py-0">
                                                ...
                                                {{ Form::select('deal_status', Hubiko\Lead\Entities\Deal::$statues, $deal->status, ['class' => 'form-control select2 px-2', 'id' => 'deal_status', 'style' => 'width: 80px;']) }}
                                                {{ Form::close() }}
                                            </span>
                                        @endpermission
                                    </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <label for="task_{{ $task->id }}" class="custom-control-label ml-4 @if ($task->status) strike @endif">
                                                                                <h6
                                                                                    ...
                                                                                    @if ($task->status)
                                                                                        <div
                                                                                            ...
                                                                                            {{ __(Hubiko\Lead\Entities\DealTask::$status[$task->status]) }}
                                                                                        </div>
                                                                                    @else
                                                                                        <div
                                                                                ...
                                                                                <div class="text-xs text-muted">
                                                                                    {{ __(Hubiko\Lead\Entities\DealTask::$priorities[$task->priority]) }}
                                                                                    -
                                                                                    <span
