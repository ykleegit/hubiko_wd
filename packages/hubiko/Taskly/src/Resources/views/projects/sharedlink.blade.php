                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif($invoice->status == 4)
                                                                <span
                                                                    class="badge fix_badges bg-success p-2 px-3">{{ __(App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @empty
                                                ...
                                                <tbody>
                                                    @forelse ($bills as $bill)
                                                            ...
                                                            <td class="Id">
                                                                @permission('bill show')
                                                                    <a target="_new"
                                                                        ...
                                                                        class="btn btn-outline-primary">{{ Hubiko\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace) }}</a>
                                                                @else
                                                                    <a
                                                                        class="btn btn-outline-primary">{{ Hubiko\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace) }}</a>
                                                        @endif
                                                        ...
                                                        <td>
                                                            @if ($bill->status == 0)
                                                                <span
                                                                    class="badge fix_badges bg-info p-2 px-3 bill_status">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                            @elseif($bill->status == 1)
                                                                <span
                                                                    class="badge fix_badges bg-primary p-2 px-3 bill_status">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                            @elseif($bill->status == 2)
                                                                <span
                                                                    class="badge fix_badges bg-secondary p-2 px-3 bill_status">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                            @elseif($bill->status == 3)
                                                                <span
                                                                    class="badge fix_badges bg-warning p-2 px-3 bill_status">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                            @elseif($bill->status == 4)
                                                                <span
                                                                    class="badge fix_badges bg-success p-2 px-3 bill_status">{{ __(Hubiko\Account\Entities\Bill::$statues[$bill->status]) }}</span>
                                                            @endif
                                                        </td>
                                                        </tr>
                                                    @empty
                                                    ...
                                                    <tr class="font-style">
                                                        <td class="Id">
                                                            <a href="{{ route('pay.retainer', \Crypt::encrypt($retainer->id)) }}"
                                                                class="btn btn-outline-primary">{{ Hubiko\Retainer\Entities\Retainer::retainerNumberFormat($retainer->retainer_id, $retainer->created_by, $retainer->workspace) }}
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            @if ($retainer->status == 0)
                                                                <span
                                                                    class="badge fix_badges bg-info p-2 px-3">{{ __(Hubiko\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 1)
                                                                <span
                                                                    class="badge fix_badges bg-primary p-2 px-3">{{ __(Hubiko\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 2)
                                                                <span
                                                                    class="badge fix_badges bg-secondary p-2 px-3">{{ __(Hubiko\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 3)
                                                                <span
                                                                    class="badge fix_badges bg-danger p-2 px-3">{{ __(Hubiko\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 4)
                                                                <span
                                                                    class="badge fix_badges bg-warning p-2 px-3">{{ __(Hubiko\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @elseif($retainer->status == 5)
                                                                <span
                                                                    class="badge fix_badges bg-success p-2 px-3">{{ __(Hubiko\Retainer\Entities\Retainer::$statues[$retainer->status]) }}</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                @endforeach
