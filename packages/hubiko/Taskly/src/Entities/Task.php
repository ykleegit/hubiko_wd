...
class   Task extends Model
{
    ...
    {
        return \Hubiko\Taskly\Database\factories\TaskFactory::new();
    }
    protected $fillable = [
        'title',
        'priority',
    ...
    {
        return $this->hasOne('Hubiko\Taskly\Entities\Project', 'id', 'project_id');
    }
    ...
    {
        return $this->hasMany('Hubiko\Taskly\Entities\Comment', 'task_id', 'id')->orderBy('id', 'DESC');
    }

    public function taskFiles()
    {
        return $this->hasMany('Hubiko\Taskly\Entities\TaskFile', 'task_id', 'id')->orderBy('id', 'DESC');
    }

    public function milestones()
    {
        return $this->hasOne('Hubiko\Taskly\Entities\Milestone', 'id', 'milestone_id');
    }
    ...
    {
        return $this->hasOne('Hubiko\Taskly\Entities\Stage', 'id', 'status');
    }

    public function sub_tasks()
    {
        return $this->hasMany('Hubiko\Taskly\Entities\SubTask', 'task_id', 'id')->orderBy('id', 'DESC');
    }
    ...
    {
        return $this->hasMany(\Hubiko\Signature\Entities\TaskSignature::class, 'task_id', 'id');
    }
}
