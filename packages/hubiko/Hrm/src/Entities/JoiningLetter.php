...
class JoiningLetter extends Model
{
    ...
    {
        return \Hubiko\Hrm\Database\factories\JoiningLetterFactory::new();
    }
    ...
    public static function defaultJoiningLetter($company_id = null,$workspace_id = null)
    {
        ...
        $defaultTemplate = [
            ...
            <p>{employee_name}</p>
            <p>{address}</p>
            <p>Konu: {designation} pozisyonuna atama</p>
            <p>Sayın {employee_name},</p>
            <p>Şirketimizde {app_name} ile {designation} pozisyonunu aşağıdaki şartlar ve</p>
            <p>conditions:</p>
            <p>1. İşe başlama</p>
            <p>İstihdamınız {start_date} itibarıyla geçerli olacaktır.</p>
            <p>2. İş unvanı</p>
            <p>İş ünvanınız şu şekilde olacak{designation}.</p>
            <p>3. Maaş</p>
            <p>Maaşınız ve diğer yan haklarınız, işbu Sözleşmenin 1. Ek\inde belirtildiği şekilde olacaktır.</p>
            <p>4. Gönderim yeri</p>
            <p>Şuraya gönderileceksiniz {branch}. Ancak, Şirketin sahip olduğu herhangi bir işyerinde çalışmanız gerekebilir veya</p>
            <p>daha sonra edinebilir.</p>
            <p>5. Çalışma Saatleri</p>
            <p>Normal çalışma günleri Pazartesi\den Cuma\ya kadardır. Gerekli olduğu kadar saat çalışmanız gerekecektir.</p>
            <p>Şirkete karşı görevlerinizi uygun şekilde yerine getirmeniz. Normal çalışma saatleri {start_time} ile {end_time} arasındadır ve siz</p>
            <p>her hafta en az {total_hours} saat çalışması bekleniyor ve gerekirse işinize bağlı olarak ek saatler de çalışabilirsiniz</p>
            <p>sorumluluklar.</p>
            <p>6. İzin/Tatil</p>
            <p>6.1 12 günlük izin hakkınız bulunmaktadır.</p>
            <p>6.2 12 iş günü ücretli hastalık iznine hakkınız var.</p>
            <p>6.3 Şirket, her yılın başında ilan edilen tatillerin listesini bildirecektir..</p>
            <p>7. Görevlerin niteliği</p>
            <p>Görevinizin gerektirdiği tüm görevleri ve şirketin ek görevlerini en iyi şekilde yerine getireceksiniz.</p>
            <p>zaman zaman sizden performans göstermenizi isteyebilir. Belirli görevleriniz, bu Ek II\de belirtilmiştir.</p>
            <p>8. Şirket malı</p>
            <p>Şirket mallarını, görev süresince resmi kullanım için size emanet edilebilecek şekilde her zaman iyi durumda muhafaza edeceksiniz.</p>
            <p>istihdamınızı ve sorumluluğunuzu devretmeden önce tüm bu mülkü Şirkete iade etmelisiniz, aksi takdirde maliyet</p>
            <p>Aynısının Şirket tarafından sizden tahsil edilmesi.</p>
            <p>9. Hediye ödünç alma/kabul etme</p>
            <p>Kişisel kazançlarınız için herhangi bir para, hediye, ödül veya tazminat ödünç almayacak veya kabul etmeyeceksiniz veya başka bir şekilde kendinizi başka bir yere koymayacaksınız.</p>
            <p>resmi ilişki içinde olabileceğiniz herhangi bir kişiye/müşteriye karşı parasal yükümlülük altındasınız.</p>
            <p>10. Fesih</p>
            <p>10.1 Şirket, size en az [Bildirim] ay önceden bildirimde bulunarak, herhangi bir sebep göstermeksizin randevunuzu sonlandırabilir</p>
            <p>yazılı bildirim veya bunun yerine maaş. Bu madde kapsamında maaş, temel maaş anlamına gelecektir.</p>
            <p>10.2 Şirketteki istihdamınızı, herhangi bir sebep göstermeden, en az [Çalışan Bildirimi] vererek sonlandırabilirsiniz.</p>
            <p>tarih itibarıyla, bekleyen izinlerin ayarlanmasından sonra kalan kaydedilmemiş dönem için aylık bildirim veya maaş.</p>
           <p>10.3 Şirket, herhangi bir ihbar süresi veya fesih ödemesi olmaksızın istihdamınızı derhal feshetme hakkını saklı tutar</p>
            <p>Suçlu olduğunuza veya ihmalkarlık yaptığınıza veya sözleşmenin temel bir ihlalini gerçekleştirdiğinize veya Şirkete herhangi bir kayba neden olduğunuza inanmak için makul bir gerekçesi varsa</p>
            <p>.</p>
            <p>10. 4 Herhangi bir nedenle istihdamınızın feshedilmesi durumunda, Şirkete tüm mülkünüzü, belgelerinizi ve</p>
            <p>herhangi bir örnek, literatür, sözleşme, kayıt, liste, çizim, plan,</p>
            <p>mektup, not, veri ve benzerleri de dahil olmak üzere hem orijinal hem de kopyaları olan kağıtlar; ve</p>
            <p>istihdamınız veya müşterilerin ticari işleri ile ilgili olarak elinizde veya kontrolünüzde bulunan Gizli Bilgiler.</p>
            <p>11. Gizli Bilgiler</p>
            <p>11. 1 Şirket\teki istihdamınız sırasında tüm zamanınızı, dikkatinizi ve becerinizi,</p>
            <p>işine en iyi şekilde adayacaksınız. Şirketin önceden izni olmadan, doğrudan veya dolaylı olarak, herhangi bir işte veya</p>
            <p>faaliyette veya herhangi bir görevde veya yarı zamanlı olarak çalışmayacak veya herhangi bir eğitim kursuna devam etmeyeceksiniz.</p>
            <p>Şirket\in önceden izni olmadan, herhangi bir işte veya</p>
            <p>faaliyette veya herhangi bir başka görevde</p>
            <p>yarı zamanlı çalışmayacak veya herhangi bir eğitim kursuna devam etmeyeceksiniz.</p>
            <p>11.2 Her zaman en yüksek gizlilik derecesini korumalı ve kayıtları, belgeleri ve diğer</p>
            <p>Şirketin işine ilişkin olarak sizin tarafınızdan bilinen veya herhangi bir şekilde size emanet edilen Gizli Bilgileri</p>
            <p>ve bu kayıtları, belgeleri ve bilgileri yalnızca Şirketin çıkarları doğrultusunda usulüne uygun şekilde yetkilendirilmiş bir şekilde kullanacaksınız.</p>
            <p>Bu maddenin amaçları doğrultusunda Gizli Bilgiler, Şirketin işi ve müşterilerinin işiyle ilgili bilgiler anlamına gelir</p>
            <p>genel kamuoyuna açık olmayan ve sizin istihdamınız sırasında öğrenebileceğiniz bilgilerdir. Bunlar şunları içerir,</p>
            <p>ancak bunlarla sınırlı olmamak üzere, kuruluşla ilgili bilgiler, müşteri listeleri, istihdam politikaları, personel ve bilgiler</p>
            <p>Şirketin ürünleri, süreçleri, fikirler, kavramlar, projeksiyonlar, teknoloji, kılavuzlar, çizimler, tasarımlar,</p>
            <p>özellikler ve bu Gizli Bilgileri içeren tüm kağıtlar, özgeçmişler, kayıtlar ve diğer belgeler hakkında bilgiler.</p>
            <p>11.3 Hiçbir zaman, izinsiz olarak ofisten herhangi bir Gizli Bilgiyi kaldıramazsınız.</p>
            <p>11.4 Koruma ve ifşa etmeme göreviniz</p>
            <p>Gizli Bilgiler, bu Sözleşmenin ve/veya Şirket\teki istihdamınızın sona ermesinden veya feshedilmesinden sonra da geçerliliğini koruyacaktır.</p>
            <p>11.5 Bu maddenin şartlarının ihlali, yukarıdaki madde uyarınca özet işten çıkarılmanıza ve ayrıca Şirketin size karşı yasal olarak sahip olabileceği diğer</p>
            <p>çözüm yollarına tabi olmanıza neden olacaktır.</p>
            <p>12. Bildirimler</p>
            <p>Bildirimler, Şirket\e kayıtlı ofis adresinde tarafınızca verilebilir. Bildirimler, Şirket tarafından size şu adreste verilebilir:</p>
            <p>resmi kayıtlarda belirttiğiniz adres.</p>
            <p>13. Şirket Politikasının Uygulanabilirliği</p>
            <p>Şirket, izin hakkı, doğum izni</p>
            <p>izin, çalışan hakları, çalışma saatleri, transfer politikaları vb. gibi konularla ilgili olarak zaman zaman politika beyanları yapma hakkına sahip olacaktır ve bunları kendi takdirine bağlı olarak zaman zaman değiştirebilir.</p>
            <p>Şirketin bu tür tüm politika kararları sizin için bağlayıcı olacak ve bu kapsamda bu Sözleşmeyi geçersiz kılacaktır.</p>
            <p>14. Yürürlükteki Yasa/Yargı Yetkisi</p>
            <p>Şirketteki istihdamınız Ülke yasalarına tabidir. Tüm anlaşmazlıklar Yüksek Mahkeme\nin yargı yetkisine tabi olacaktır.</p>
            <p>Yalnızca Gujarat.</p>
           <p>15. Teklifimizin kabulü</p>
            <p>Lütfen bu İstihdam Sözleşmesini kabul ettiğinizi imzalayarak ve kopyasını geri göndererek teyit edin.</p>
            <p>Sizi memnuniyetle karşılıyoruz ve kabulünüzü almayı ve sizinle çalışmayı dört gözle bekliyoruz.</p>
            <p>Saygılarımla,</p>
            <p>{app_name}</p>
            <p>{date}</p>',
     ...
     {
            $joiningletter = JoiningLetter::where('lang',$lang)->where('workspace',$workspace_id)->where('created_by',$company_id)->first();
