...
class ExperienceCertificate extends Model
{
    ...
    {
        return \Hubiko\Hrm\Database\factories\ExperienceCertificateFactory::new();
    }
    ...
    public static function defaultExpCertificat($company_id = null, $workspace_id = null)
    {
        $defaultTemplate = [
            ...
            'tr' => '<p lang="en-IN" style="margin-bottom: 0cm; direction: ltr; line-height: 2; text-align: center;" align="center"><span style="font-size: 18pt;"><strong>Deneyim Mektubu</strong></span></p>
            <p>{app_name}</p>
            <p>İLGİLİ MAKAMA</p>
            <p>{date}</p>
            <p>{employee_name}</p>
            <p>Hizmet Süresi {duration} {app_name} içinde.</p>
            <p>{designation}</p>
            <p>{payroll}</p>
            <p>Roller ve Sorumluluklar</p>
            <p>Çalışanın iş deneyiminin kısa açıklaması ve yönetici veya amirden olumlu bir beyan.</p>
            <p>Samimi olarak,</p>
            <p>{employee_name}</p>
            <p>{designation}</p>
            <p>İmza</p>
