...
class NOC extends Model
{
    ...
    {
        return \Hubiko\Hrm\Database\factories\NOCFactory::new();
    }
    ...
    public static function defaultNocCertificate($company_id = null, $workspace_id = null)
    {
        $defaultTemplate = [
            ...
            <p>Bu sertifika, Bayan / Bay {employee_name}\in başka bir organizasyona katılması ve hizmetlerini sunması durumunda bir No Objection Certificate (NoC) talep etmek içindir. Tüm bakiyelerini temizlediği ve {app_name} Şirketi\nden teminatını aldığı için bildirilir..</p>

            <p>Kendisine gelecekte başarılar dileriz..</p>
