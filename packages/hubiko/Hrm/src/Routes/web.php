...
use Hubiko\Hrm\Http\Controllers\AllowanceController;
use Hubiko\Hrm\Http\Controllers\AllowanceOptionController;
use Hubiko\Hrm\Http\Controllers\AllowanceTaxController;
use Hubiko\Hrm\Http\Controllers\AnnouncementController;
use Hubiko\Hrm\Http\Controllers\AttendanceController;
use Hubiko\Hrm\Http\Controllers\AwardController;
use Hubiko\Hrm\Http\Controllers\AwardTypeController;
use Hubiko\Hrm\Http\Controllers\BranchController;
use Hubiko\Hrm\Http\Controllers\CommissionController;
use Hubiko\Hrm\Http\Controllers\CompanyContributionController;
use Hubiko\Hrm\Http\Controllers\CompanyPolicyController;
use Hubiko\Hrm\Http\Controllers\ComplaintController;
use Hubiko\Hrm\Http\Controllers\DeductionOptionController;
use Hubiko\Hrm\Http\Controllers\DepartmentController;
use Hubiko\Hrm\Http\Controllers\DesignationController;
use Hubiko\Hrm\Http\Controllers\DocumentController;
use Hubiko\Hrm\Http\Controllers\DocumentTypeController;
use Hubiko\Hrm\Http\Controllers\EmployeeController;
use Hubiko\Hrm\Http\Controllers\EventController;
use Hubiko\Hrm\Http\Controllers\HolidayController;
use Hubiko\Hrm\Http\Controllers\HrmController;
use Hubiko\Hrm\Http\Controllers\IpRestrictController;
use Hubiko\Hrm\Http\Controllers\LeaveController;
use Hubiko\Hrm\Http\Controllers\LeaveTypeController;
use Hubiko\Hrm\Http\Controllers\LoanController;
use Hubiko\Hrm\Http\Controllers\LoanOptionController;
use Hubiko\Hrm\Http\Controllers\OtherPaymentController;
use Hubiko\Hrm\Http\Controllers\OvertimeController;
use Hubiko\Hrm\Http\Controllers\PaySlipController;
use Hubiko\Hrm\Http\Controllers\PayslipTypeController;
use Hubiko\Hrm\Http\Controllers\PromotionController;
use Hubiko\Hrm\Http\Controllers\ReportController;
use Hubiko\Hrm\Http\Controllers\ResignationController;
use Hubiko\Hrm\Http\Controllers\SaturationDeductionController;
use Hubiko\Hrm\Http\Controllers\SetSalaryController;
use Hubiko\Hrm\Http\Controllers\TaxBracketController;
use Hubiko\Hrm\Http\Controllers\TaxRebateController;
use Hubiko\Hrm\Http\Controllers\TaxThresholdController;
use Hubiko\Hrm\Http\Controllers\TerminationController;
use Hubiko\Hrm\Http\Controllers\TerminationTypeController;
use Hubiko\Hrm\Http\Controllers\TransferController;
use Hubiko\Hrm\Http\Controllers\TravelController;
use Hubiko\Hrm\Http\Controllers\WarningController;
