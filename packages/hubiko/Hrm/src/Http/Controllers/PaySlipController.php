...
use Hubiko\Hrm\Entities\Allowance;
use Hubiko\Hrm\Entities\Commission;
use Hubiko\Hrm\Entities\CompanyContribution;
use Hubiko\Hrm\Entities\Employee;
use Hubiko\Hrm\Entities\Loan;
use Hubiko\Hrm\Entities\OtherPayment;
use Hubiko\Hrm\Entities\Overtime;
use Hubiko\Hrm\Entities\PaySlip;
use Hubiko\Hrm\Entities\Resignation;
use Hubiko\Hrm\Entities\SaturationDeduction;
use Hubiko\Hrm\Entities\Termination;
use Hubiko\Hrm\Events\CreateMonthlyPayslip;
use Hubiko\Hrm\Events\CreatePaymentMonthlyPayslip;
use Hubiko\Hrm\Events\DestroyMonthlyPayslip;
use Hubiko\Hrm\Events\PayslipSend;
use Hubiko\Hrm\Events\UpdateMonthlyPayslip;
