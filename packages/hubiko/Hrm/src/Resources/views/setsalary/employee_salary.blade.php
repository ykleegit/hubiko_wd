                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($allowances as $allowance)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($allowance->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($allowance->employee_id)->name : '' }}
                                                    </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($commissions as $commission)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($commission->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($commission->employee_id)->name : '' }}
                                                    </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($loans as $loan)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($loan->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($loan->employee_id)->name : '' }}
                                                    </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($saturationdeductions as $saturationdeduction)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($saturationdeduction->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($saturationdeduction->employee_id)->name : '' }}
                                                    </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($otherpayments as $otherpayment)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($otherpayment->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($otherpayment->employee_id)->name : '' }}
                                                    </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($overtimes as $overtime)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($overtime->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($overtime->employee_id)->name : '' }}
                                                    </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @forelse ($companycontributions as $companycontribution)
                                                <tr>
                                                    <td>{{ !empty(Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($companycontribution->employee_id)) ? Hubiko\Hrm\Entities\Employee::GetEmployeeByEmp($companycontribution->employee_id)->name : '' }}
                                                    </td>
