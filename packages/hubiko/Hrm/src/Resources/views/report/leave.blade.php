                                            ...
                                            <td>
                                                @permission('employee show')
                                                    <a class="btn btn-outline-primary"
                                                        href="{{ route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt($leave['id'])) }}">{{ Hubiko\Hrm\Entities\Employee::employeeIdFormat($leave['employee_id']) }}</a>
                                                @else
                                                    <a  class="btn btn-outline-primary">{{Hubiko\Hrm\Entities\Employee::employeeIdFormat($leave['employee_id'])}}</a>
                                                @endpermission
                                            </td>
                                        @else
                                            <td>--</td>
